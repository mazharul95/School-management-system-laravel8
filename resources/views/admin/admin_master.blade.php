...
<head>
    ...
    <link href="('https://fonts.googleapis.com/css?family=Montserrat:400,500|Poppins:400,500,600,700|Roboto:400,500')"
        rel="stylesheet"/>
    <link href=" {{asset('backend/https://cdn.materialdesignicons.com/3.0.39/css/materialdesignicons.min.css')}}"
          rel="stylesheet"/>
    <!-- PLUGINS CSS STYLE -->
    ...
    <div class="page-wrapper">
            ...
            <nav class="navbar navbar-static-top navbar-expand-lg">
                ...
                <div class="search-form d-none d-lg-inline-block">
                    <div class="input-group">
                        ...
                        <label for="search-input"><input type="text" name="query" id="search-input" class="form-control"
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2019</span> Copyright Easy Dashboard
                    <a
                        class="text-primary"
